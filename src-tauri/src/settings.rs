...
pub struct EchoSettings {
    ...
    pub parakeet_model_name: String,
...
impl Default for EchoSettings {
    fn default() -> Self {
        Self {
            ...
            undo_hotkey: "CommandOrControl+Shift+U".into(),
            ...
            whisper_model_name: "ggml-base.en.bin".into(),
            parakeet_model_name: crate::transcription::parakeet::DEFAULT_PARAKEET_MODEL.into(),
            open_at_login: false,
